...
/**
 * Created by andilyliao on 16-8-13.
 */
...
public class TT {
    ...
    private static void ethernet() throws SigarException {
        Sigar sigar1 = null;
        sigar1 = new Sigar();
        String[] ifaces = sigar1.getNetInterfaceList();
        for (int i = 0; i < ifaces.length; i++) {
            NetInterfaceConfig cfg = sigar1.getNetInterfaceConfig(ifaces[i]);
        ...
        try {
            ...
            for (String name : nis) {
                try {
                    ...
                    System.out.println("发现网卡:" + ifconfig.getHwaddr() + ",IP:" + ifconfig.getAddress());
